...
export default function MarriageMatchingPage() {
  ...
  const WA_LINK = "https://wa.me/919444559071?text=Hello%20Gokul's%20Astrological%20Insights,%20I%20want%20to%20enquire%20about%20Marriage%20Matching%20services.";
        ...
        <div className="mm-container">
          <div className="mm-footer-grid">
            ...
            <div>
              ...
              <a href={WA_LINK} className="mm-footer-link">📱 +91 9444 55 9071</a>
              <a href="mailto:gokulsastrologicalinsights@gmail.com" className="mm-footer-link">📧 gokulsastrologicalinsights@gmail.com</a>
            </div>
            <div>
              <h4 className="mm-footer-h4">Follow Us</h4>
              <div className="mm-footer-social">
                <a href="#" className="mm-social-btn">YT</a>
                <a href="#" className="mm-social-btn">IG</a>
                <a href="#" className="mm-social-btn">FB</a>
              </div>
            </div>
          </div>
