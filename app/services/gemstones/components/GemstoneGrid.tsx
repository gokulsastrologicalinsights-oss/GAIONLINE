...
const gemstones: Gemstone[] = [
  ...
  },
  {
    ...
    planet: "Venus",
    pricePerCarat: 24999,
    benefits: ["Luxury & Wealth", "Relationships", "Artistic Talents", "Beauty & Charm"],
    whoCanWear: "Recommended for creative artists, actors, luxury merchants, and individuals seeking harmonious relationships, marital bliss, and Venusian prosperity.",
    raasi: ["Taurus (Rishabam)", "Libra (Thulaam)"],
    lagna: ["Taurus Lagna", "Libra Lagna", "Gemini Lagna", "Virgo Lagna", "Capricorn Lagna", "Aquarius Lagna"],
    color: "#bae6fd",
  },
  {
    id: "blue-sapphire",
