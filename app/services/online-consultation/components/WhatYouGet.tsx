...
const helpAreas = [
  {
    ...
    desc: "Compatibility matching (Jathaga Porutham), marriage timing predictions, and relationship resolution guidance.",
    color: "bg-rose-50 border-rose-100 text-rose-600",
  },
  {
    icon: "💼",
    title: "Career and Job Growth",
    desc: "Finding the right career path, job change/promotion timing, and overcoming growth stagnation.",
    color: "bg-indigo-50 border-indigo-100 text-indigo-600",
  },
  {
    icon: "💰",
    title: "Finance and Wealth",
    desc: "Wealth accumulation insights, debt clearance guidance, and timing for financial stability.",
    color: "bg-emerald-50 border-emerald-100 text-emerald-600",
  },
  {
    icon: "🏠",
    title: "Property and House Purchase",
    desc: "Best planetary windows for buying a house, purchasing land, or acquiring new vehicles.",
    color: "bg-amber-50 border-amber-100 text-amber-600",
  },
  {
    icon: "👶",
    title: "Child Birth and Family Life",
    desc: "Astrological analysis for child birth timing, family expansion, and domestic harmony.",
    color: "bg-sky-50 border-sky-100 text-sky-600",
  },
  {
    icon: "📈",
    title: "Business Growth",
    desc: "Timing for new business launches, partner compatibility, and selecting profitable niches.",
    color: "bg-blue-50 border-blue-100 text-blue-600",
  },
  {
    icon: "🪔",
    title: "Doshas and Remedies",
    desc: "Identifying Sevvai, Rahu-Ketu, or Kalasarpa doshas, along with simple, practical remedies.",
    color: "bg-orange-50 border-orange-100 text-orange-600",
  },
  {
    icon: "⭐",
    title: "General Life Guidance",
    desc: "Overview of your current planetary periods (Dasha) and clarity for key decisions.",
