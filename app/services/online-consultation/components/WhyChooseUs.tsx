...
const features = [
  {
    ...
    desc: "Expert Vedic & KP Astrologer providing precise analysis of your Jathagam.",
    color: "bg-indigo-50/50 border-indigo-100/50 text-indigo-600",
  },
  {
    icon: "⭐",
    title: "Personalized Consultation",
    desc: "Tailored 1-on-1 sessions addressing your specific questions, chart, and timeline.",
    color: "bg-amber-50/50 border-amber-100/50 text-amber-600",
  },
  {
    icon: "📌",
    title: "Astrosage ID: 11195",
    desc: "Verified expert astrologer badge on world's leading online astrology platform.",
    color: "bg-violet-50/50 border-violet-100/50 text-violet-600",
  },
  {
    icon: "🌍",
    title: "Clients from India and Abroad",
    desc: "Guiding clients across India and globally including USA, UK, Canada, and Singapore.",
    color: "bg-blue-50/50 border-blue-100/50 text-blue-600",
  },
  {
    icon: "🔒",
    title: "Confidential Guidance",
    desc: "Your personal details, birth chart details, and discussions are kept 100% private.",
    color: "bg-emerald-50/50 border-emerald-100/50 text-emerald-600",
  },
  {
    icon: "📞",
    title: "Direct WhatsApp Support",
    desc: "Direct communication on WhatsApp for seamless booking, scheduling, and follow-ups.",
