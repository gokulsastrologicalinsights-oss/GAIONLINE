...
import RemedyAnalysis from "./components/RemedyAnalysis";
import ServicePackages from "./components/ServicePackages";
import AdditionalServices from "./components/AdditionalServices";
import OnlineOfflineSection from "./components/OnlineOfflineSection";
import ProcessTimeline from "./components/ProcessTimeline";
import SpiritualForm from "./components/SpiritualForm";
...
export default function SpiritualPage() {
  ...
  const WA_LINK = "https://wa.me/919444559071?text=Hello%20Gokul's%20Astrological%20Insights,%20I'm%20interested%20in%20Spiritual%20Remedies.";
  ...
  return (
    <div className="sp-root">
      ...
      <HeroSection />
      <RemedyAnalysis />
      <ServicePackages onSelect={handleSelectPackage} />
      <AdditionalServices />
      <OnlineOfflineSection />
      <ProcessTimeline />
      <SpiritualForm selectedPackage={selectedPkg} />
      <WhyChooseUs />
      <Testimonials />
      <FAQSection />
      <FinalCTA />
